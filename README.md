...
* Для того чтобы реализовать логику реализации периодических задач использовались Celery и Redis (при реализации данных процессов возникли проблемы, так как на ПК установлен Windows10, а Celery не очень дружит с ним, пришлось искать варианты решения. 
