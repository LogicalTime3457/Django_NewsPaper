...
* В файле settings.py настроено логирование информации о работе приложения.
* В приложении настроен перевод текста английский-руский и обратно, реализована кнопка для выбора языка.
* Реализована смена часовых поясов, есть кнопка для выбора тайм зоны, установлена темная тема (с 19-00 до 07-00).
